...
\begin{enumerate}
    \item \xxx{Analysis - problem description, other existing solutions, data used}
    \item \xxx{Design - implementation, solutions, alternatives}
    \item \xxx{Documentation - user and programmer}
    \item \xxx{Testing}
\end{enumerate}
\xxx{}
