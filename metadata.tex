...
\def\Dedication{%
I would like to thank my supervisor doc. Mgr. Martin Nečaský, Ph.D. for his help and advice towards this thesis. I would also like to thank my family for supporting me throughout my studies and the work on this thesis. Finally, I would also like to thank my girlfriend Eliška for helping to keep me sane during my studies.
}
...
\def\ThesisKeywords{%
route search \sep open data \sep public transit \sep Prague \sep multimodal transit \sep bikesharing
}
...
vyhledávání tras \sep otevřená data \sep MHD \sep Praha \sep multimodální doprava \sep bikesharing
}

\def\AbstractCS{%
Ve světě i v České republice existuje řada řešení pro hledání spojení veřejnou dopravou. Jsou však navržena tak, aby oslovila co nejširší okruh uživatelů. To znamená, že musí být velmi jednoduchá na používání a musí obsluhovat co nejširší území. Kvůli tomu ale postrádají pokročilejší možnosti konfigurace a obvykle nejsou optimalizována pro použití v jednotlivých konkrétních městech. Tento univerzální design přehlíží skutečnost, že velká část uživatelů hledá v rámci konkrétního města spojení především na trasách, které již částečně znají, a mohou tak poskytnout cenné podněty k optimalizaci jejich cest a dojíždění ve městě. Aplikace vyvinutá v rámci této práce se zabývá těmito problémy a jejím cílem je poskytnout přizpůsobitelné a optimalizované vyhledávání spojení lidem využívajícím síť pražské MHD. Aplikace také integruje do vyhledávání bikesharingové služby, což umožňuje uživatelům najít lepší spojení tam, kde se využití sdílených kol může vyplatit.
}
